                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        switch (item.getItemId()) {
                            case R.id.xacnhan:
                                ...
                                try {
                                    postData.put("madonahng",finalViewHolder.tvmadonhang.getText().toString());
                                    ...
                                    postData.put("tongtien", finalViewHolder.tvgiatien.getText().toString());
                            ...
                            case R.id.danggiao:
                                ...
                                //tensp,gia,hinhanhsp,soluong,mota,idsanpham
                                try {
                                    postData1.put("madonahng",finalViewHolder.tvmadonhang.getText().toString());
                                    ...
                                    postData1.put("tongtien", finalViewHolder.tvgiatien.getText().toString());
                            ...
                            case R.id.hoanthanh:
                                ...
                                try {
                                    ...
                                    postData2.put("tongtien", finalViewHolder.tvgiatien.getText().toString());
